...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userTag = this.repository.create({
                            id_tag: id_tag,
                            name: name,
                            permission: permission,
                            github_link: github_link,
                        });
                        return [4 /*yield*/, this.repository.save(userTag)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    UsersRepository.prototype.findByID = function (id_tag) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.findOne({ id_tag: id_tag })];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user];
                }
