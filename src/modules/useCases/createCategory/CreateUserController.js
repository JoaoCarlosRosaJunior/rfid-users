...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id_tag, name, permission, github_link, createUserUseCase, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log("chegou");
                        _a = request.body, id_tag = _a.id_tag, name = _a.name, permission = _a.permission, github_link = _a.github_link;
