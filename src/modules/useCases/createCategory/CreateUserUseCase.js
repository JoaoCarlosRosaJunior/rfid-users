...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        var id_tag = _a.id_tag, name = _a.name, permission = _a.permission, github_link = _a.github_link;
        return __awaiter(this, void 0, void 0, function () {
            var userAlreadyExist;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByName(name)];
                    case 1:
                        ...
                        this.usersRepository.create({ id_tag: id_tag, name: name, permission: permission, github_link: github_link });
                        return [2 /*return*/];
                }
            });
        });
    ...
    CreateUserUseCase = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)(UsersRepository_1.UsersRepository)),
